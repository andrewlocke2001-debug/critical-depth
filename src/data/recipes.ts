...
export const RECIPES: Recipe[] = [
  ...
  { id: 'everglow2', name: 'Everglow Torch ×2', out: 'everglow', n: 2, bench: 'work',
    mats: { glowshroom: 1, stone: 1 },
    desc: 'Bottled shroomlight — wider radius than a torch, and it never learned how to die.' },
